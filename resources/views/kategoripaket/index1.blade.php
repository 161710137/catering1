                                ...
                                <div class="main-menu text-right">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="{{route('kategorimakanan1')}}">Kategori Paket</a></li> -->
                    ...
                    <div class="event-owl">
                       ...
                       <div class="col-md-12">
                            <div class="single-event text-center">
                                <div class="event-img">
                                   <a href="{{route('isipaket',$data->id)}}"><img src="{{asset('assets/fe/img/event/'.$data->gambar)}}" style="height: 200px;width: 300px;margin-top: 7px"></a>
                                </div>
