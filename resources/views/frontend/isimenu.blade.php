				...
				<div class="container">
					...
					<div id="navbar" class="navbar-right">
						<ul id="mainmenu" class="nav navbar-nav nav-menu">
							...
							<li class="active"><a href="{{route('makanan_frontend')}}">Menu</a></li>
                        ...
                        <div class="display-table">
                            <div class="table-cell">
                                <div class="slider_content align-center">
                                    ...
                                    <h1 class="text-black">Rai Catering</h1>
                                    <p class="text-black">ADA ACARA MENDADAK DI BANDUNG ? CARI CATERING ENAK DAN HARGA TERJANGKAU ?<br> RAI CATERING PILIHANNYA.</p>
                                    <!-- <div class="btn_group">
                        ...
                        <div class="tab-pane fade tab_content in active" id="ayam">
                            ...
                            <div class="col-sm-4 col-xs-6 xs-padding">
                                <div class="food_content align-center">
                                    <img src="{{asset('assets/hangout/img/f-1.jpg') }}" alt="food">
                                    <h3>{{$data->makanan}}</h3>
                                    <p>Lorem Ipsum is simply dummy text printing and business restaurant industry.</p>
