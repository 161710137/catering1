    ...
    <body>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-right">
						<ul id="mainmenu" class="nav navbar-nav nav-menu">
                            <li class="active"><a href="{{route('catering')}}">Beranda <span class="sr-only">(current)</span></a>
                            </li>            
		...
		<section class="slider_section">
            <ul id="main-slider" class="owl-carousel main_slider">
                <li class="main_slide" style="background-image: url(assets/hangout/img/i-18.jpg);">
                    <div class="container">
                ...
                <li class="main_slide" style="background-image: url(assets/hangout/img/i-45.jpg);">
                    <div class="container">
                        <div class="display-table">
                            <div class="table-cell">
                                <div class="slider_content align-center">
                ...
                <li class="main_slide" style="background-image: url(assets/hangout/img/i-20.jpg);">
                    <div class="container">
                        <div class="display-table">
                            <div class="table-cell">
                                <div class="slider_content align-center">
            ...
            <div class="container">
                <div class="col-sm-6">
                    <div class="about_content">
                        <h2 class="mb-15">Rai Catering<br>Layanan Catering Dikota Bandung </h2>
                        <p>Makanan Terbaik Yang Membuat Perasaan Menjadi Lebih Baik!</p>
                ...
                <div class="col-sm-6 hidden-xs">
                    <div class="about_img">
                        <img src="{{asset('assets/hangout/img/i-31.jpg') }}" width="300" height="400" alt="idea-images" class="about_img_1">
                        <img src="{{asset('assets/hangout/img/i-25.jpg') }}" width="300" height="400" alt="idea-images" class="about_img_2">
                    </div>
                </div>
            </div>
        ...
        <div class="special_food bg-grey bd-bottom padding">
            <div class="container">
                <div class="section_heading align-center mb-40">
                    <h2>Menu Spesial</h2>
                    <p>Rai Catering memliki menu spesial.</p>
                </div><!-- /.section_heading -->
                <ul id="food_carousel" class="food_items owl-carousel">
                    <li class="food_item">
                            <img src="assets/hangout/img/ayam-kemangi.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/beef-sukiyaki.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/chicken-teriyaki.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/cumi-kailan.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/fruit-salad.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/iga-bakar.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/kakap-asam-manis.jpg" alt="food-image" height="250">
                    </li>
                    <li class="food_item">
                            <img src="assets/hangout/img/sop-baso.jpg" alt="food-image" height="250">
                    </li>
                </ul>
            </div>
        </div><!-- ./special_section -->
       
       <section id="gallery" class="gallery_section bg-grey padding">
			<div class="container">
				<div class="section_heading align-center mb-40">
					<h2>Gallery Rai Catering</h2>
					<!-- <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> -->
				</div><!-- /.section_heading -->
            </div>
            <div class="container-fluid no-padding">
                <ul class="gallery_items">
                	<li class="col-sm-4 col-xs-6 single_item branding">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-3.jpg') }}" alt="gallery Item" height="700">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-3.jpg') }}" class="img_popup" >
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                			</figcaption>
                		</figure>
                	</li>
                	<li class="col-sm-4 col-xs-6 single_item photo">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-16.jpg') }}" alt="gallery Item">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-16.jpg') }}" class="img_popup">
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                	...
                	<li class="col-sm-4 col-xs-6 single_item print branding">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-43.jpg') }}" alt="gallery Item" height="700">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-43.jpg') }}" class="img_popup">
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                	...
                	<li class="col-sm-4 col-xs-6 single_item website photo">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-27.jpg') }}" alt="gallery Item" height="550">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-27.jpg') }}" class="img_popup">
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                	...
                	<li class="col-sm-4 col-xs-6 single_item print photo">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-15.jpg') }}" alt="gallery Item">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-15.jpg') }}" class="img_popup">
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                	...
                	<!-- <li class="col-sm-4 col-xs-6 single_item branding website">
                		<figure class="gallery_item">
                			<img src="{{asset('assets/hangout/img/i-18.jpg') }}" alt="gallery Item">
                			<figcaption class="overlay">
                				<a href="{{asset('assets/hangout/img/i-18.jpg') }}" class="img_popup">
                					<div class="table-cell">
                						<h3>Kegiatan Rai Catering</h3>
                					</div>
                				</a>
                    ...
                    <li class="col-sm-4 col-xs-6 single_item branding website">
                        <figure class="gallery_item">
                            <img src="{{asset('assets/hangout/img/i-17.jpg') }}" alt="gallery Item">
                            <figcaption class="overlay">
                                <a href="{{asset('assets/hangout/img/i-17.jpg') }}" class="img_popup">
                                    <div class="table-cell">
                                        <h3>Kegiatan Rai Catering</h3>
                                    </div>
                                </a>
		...
		</section><br><br><!-- /.testimonial_section -->
