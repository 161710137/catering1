                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-right">
                        <ul id="mainmenu" class="nav navbar-nav nav-menu">
                            <li><a href="{{route('catering')}}">Beranda <span class="sr-only">(current)</span></a>
                            </li>            
                            <li class="active"><a href="{{route('cabang1')}}">Cabang</a></li>
                            <li><a href="{{route('makanan_frontend')}}">Menu</a></li>
                            <li> <a href="#">Kategori Paket</a>
                                <ul>
                                    @foreach($categori_paket as $data)
                                    <li  class="active"><a href="{{route('isipaket',$data->id)}}">{{$data->kategori}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        </ul>
        ...
        <section id="news" class="blog_section bd-bottom padding">
            <div class="container">
                <div class="section_heading align-center mb-40">
                    <h2>Cabang Rai Catering</h2>
                    <p>Rai Catering baru mempunyai 2 cabang.</p>
                </div>
                <div class="col-sm-4 col-xs-6 xs-padding">
                    <div class="blog_post">
                        <img src="{{asset('assets/hangout/img/kantin.jpg') }}" alt="blog-image">
            ...
            <div class="container">
                <ul id="sponsor_carousel" class="sponsor_items owl-carousel">
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-1.png') }}" alt="sponsor-image">
                    </li>
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-2.png') }}" alt="sponsor-image">
                    </li>
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-3.png') }}" alt="sponsor-image">
                    </li>
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-4.png') }}" alt="sponsor-image">
                    </li>
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-5.png') }}" alt="sponsor-image">
                    </li>
                    <li class="sponsor_item">
                        <img src="{{asset('assets/hangout/img/sponsor-1.png') }}" alt="sponsor-image">
                    </li>
