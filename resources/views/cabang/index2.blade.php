...
<html class="no-js" lang="en">
    ...
    <body>
                            ...
                            <div class="content-wrapper">
                                ...
                                <div class="main-menu text-right">
                                    <nav>
                                        ...
                                        </ul>    <li><a href="contact.html"></a></li>
                                        </ul>
                                    </nav>
                                </div>
		...
		<!-- Banner Area End -->
        <!-- About Start -->
        <!-- <section class="about-area two mt-130">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="about-wrapper">
                            <div class="about-img">
                                <a href="#"><img src="{{asset('assets/fe/img/about/about.jpg')}}" alt="about"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about-content pt-25">
                            <div class="section-title">
                                <h2>Panshi The Best<br>
                                    Catering Service in the City </h2>
                                <h4>The best food make you feel good!</h4>
                                <p>Panshi the best theme for  elit, sed do eiusmod tempor dolor sit amet, conse ctetur adiog elit, sed do eiusmod tempor incididunt ut labore et lorna iquatd minimam, is nostrud iono oris nisi ut aliquip ex ea On the other hand, we denounce with righteous indignation and a ike men who are so beguiled and demoralized. </p>
                    ...
                    <div class="event-owl">
                       <div class="col-md-12">
                            <div class="single-event text-center">
                                <div class="event-img">
                                   <a href="service.html"><img src="{{asset('assets/fe/img/event/kantin.jpg')}}" alt="event"></a>
                                </div>
                                <h4>Jl. Moch. Ramdhan No.16</h4>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="single-event text-center">
                                ...
                                <h4><a href="service.html">Lembang</a></h4>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="single-event text-center">
                                ...
                                <h4><a href="service.html">Jogja</a></h4>
                            </div>
                        </div>
                       <div class="col-md-12">
                            <div class="single-event text-center">
        ...
        <section class="footer-area">
            <div class="subscribe-area menu pt-130 pb-130">
                <div class="container">
                    <div class="row">
