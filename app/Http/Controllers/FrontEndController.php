...
class FrontEndController extends Controller
{
    public function index()
    {
        ...
        $makanan=makanan::all();
    	return view('frontend.index2',compact('galeri','categori_paket','kategori_makanan','makanan'));
    }
    ...
    public function isikategorimakanan($id)
    {
        ...
        $makanan= makanan::all();
            return view('frontend.isimenu',compact('categori_makanan','kategori_makanan','makanan'));
    }
}
